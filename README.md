...
4. ¿Qué diferencia existe entre vTaskDelay() y vTaskDelayUntil()? ¿En cuál de las tareas de esta práctica sería más apropiado usar vTaskDelayUntil()?  
...
5. ¿Por qué vTaskLedRapido tiene prioridad menor que vTaskMonitor? Describe qué ocurriría si se invirtieran esas prioridades.  
...
6. ¿Qué riesgo existe al leer una variable volatile desde dos tareas distintas sin protección? Investiga el concepto de sección crítica.  
